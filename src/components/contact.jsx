...
export default function Contact() {
  return (
    <section id="contact-section" className="contact-section w-full max-w-screen-md mx-auto">
      ...
      <div className="contact-details-grid mb-12">
        {items.map(({ id, Icon, text }) => (
          <a key={id} href="#" className="grid-item text-gray-700 rounded-md dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-500">
